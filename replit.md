...
### Recent Changes
**October 12, 2025 - Hero Section CTA Update:**
- **Start Bidding Today Button**: Updated to redirect to /dashboard instead of /signin
- **Direct Access**: Users can now access auctions directly from landing page CTA
...
- **Mobile-First Design**: Profile avatar hidden on mobile (sm breakpoint and below), only visible on desktop
- **Simplified Mobile**: Clean mobile navbar with just logo (left) and hamburger menu (right)
- **Consistent Layout**: Applied to all dashboard pages (dashboard, mybids, etc.)
