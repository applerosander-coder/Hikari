...
- **Landing Page Confetti Effect:** Added CoolMode particle animation to "Start Bidding Today" button. When users touch/hold the button, colorful particles shoot out in random directions (same effect as "Get Auction Alerts" button). Button no longer redirects to dashboard - purely decorative interaction for engagement.
