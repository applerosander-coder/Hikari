...
- **Landing Page Confetti Effect:** Added CoolMode particle animation to "Start Bidding Today" button. When users touch/hold the button, gold/silver/white confetti particles (matching background glitter style) shoot out in random directions with sparkle effects. Mix of circles and squares for variety, same aesthetic as "Get Auction Alerts" button. Button no longer redirects to dashboard - purely decorative interaction for engagement.
